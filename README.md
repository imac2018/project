...
Et en fait, dès que tu commences/reprend un projet, tu crées le sous-dossier approprié à ton nom, et tu bosses directement dedans.

Au début de chaque projet, tu fais :
- `cd <le_dossier_tds>`
- `git pull`
...
Mais nommage conseillé pour pas foutre le bordel ^^ : `<nom_cours>/<nom_projet_et_initialnom>/<file>`
